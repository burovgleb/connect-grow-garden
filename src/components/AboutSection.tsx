      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="brand-title text-3xl md:text-5xl text-foreground leading-[1.2] mb-8">
              ...
              <span className="text-muted-foreground">
                а не классический весенний уходовый выезд
              </span>
            </h2>
            <div className="space-y-6 text-base font-light leading-[1.85] text-foreground/84">
              ...
              <p>
                На этот раз формат камерный и рассчитан на садовников с
                опытом: будем глубже работать с компостом, весенней
                подготовкой огорода и знакомиться с отличиями весенних работ
                в экосаду от классических работ — обработки, внесения
                минеральных удобрений и уборки органики прошлого сезона. Йога
                подготовит тела к работе, общий обед и разговоры дадут этому
                дню тёплую дружескую атмосферу и глубину восприятия сада.
              </p>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="brand-panel overflow-hidden p-4 md:p-5">
              <div className="overflow-hidden rounded-[1.75rem] border border-black/5 shadow-[0_30px_80px_-48px_rgba(31,31,31,0.2)]">
              ...
              <div className="px-1 pb-1 pt-5 md:px-2">
                <p className="brand-kicker mb-3">
                  сад RECOVERY*
                </p>
                <div className="space-y-4 text-base font-light leading-[1.85] text-foreground/84">
                  <p>
