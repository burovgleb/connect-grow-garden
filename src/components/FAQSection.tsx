...
const faqs: Array<{ q: string; a: ReactNode }> = [
  {
    ...
    a: (
      <div className="space-y-3">
        ...
        <p>
          В этот раз в фокусе — создание мульчирующего компоста,
          подготовка зоны огорода к сезонным посадкам, запуск компостной
          системы и внесение готового компоста в цветники.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    a: "Да. Этот день мы делаем для садовников с опытом: не обязательно профессиональным, но достаточным, чтобы уверенно чувствовать себя в сезонной работе и глубже войти в задачи сада.",
  },
  {
    q: "Это бесплатно?",
  ...
  },
  {
    ...
    a: "Это камерный формат — всего 8 участников. Так мы можем работать глубже, точнее и сохранить человеческий масштаб общения в течение дня.",
  },
  {
