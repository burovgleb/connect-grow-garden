      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="mx-auto mb-4 max-w-xl text-base font-light leading-[1.85] text-foreground/80 md:text-lg">
            Камерный день живой практики пройдёт 16 мая 2026. Это формат
            для садовников с опытом: группа — всего 8 участников. После
            заявки мы пришлём адрес сада, список вещей и ссылку на общий
            чат.
          </p>
          <p className="brand-kicker mb-10">
            Участие бесплатное · 8 участников · Для садовников с опытом
          </p>
