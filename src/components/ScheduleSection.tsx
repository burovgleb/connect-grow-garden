...
const tasks = [
  "Создание мульчирующего компоста",
  "Подготовка зоны огорода к сезонным посадкам",
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base font-light leading-[1.8] text-foreground/74">
            ...
            наблюдением и общением. На этот раз группа камерная, а задачи
            рассчитаны на участников с опытом работы в саду.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 mt-16">
          ...
          >
            ...
            <div className="space-y-4 text-sm font-light leading-[1.75] text-foreground/78">
              <p>
                Работаем по зонам и меняемся в течение дня, чтобы глубже
                пройти разные типы задач и не потерять живой ритм.
              </p>
              <p>
                Утром настраиваемся через движение и внимание, затем
                входим в более точные сезонные работы: компост, огород и
                подготовку сада к активному времени года.
              </p>
              <p>
                Этот формат помогает не только сделать полезную работу, но
                и прожить сад как систему, которая меняется во времени и
                требует более зрелого взгляда на уход.
              </p>
            </div>
          </motion.div>
        </div>
